        ...
        <div class="container">
            <div class="row flex-row-reverse">
                ...
                <div class="about-image col-lg-6 col-12 mb-30">
                    <a class="video-popup" href="https://www.youtube.com/watch?v=7e90gBu4pas"> <img src="assets/img/about.jpg" alt=""></a>
                </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="client-slider text-center">
                        ...
                        <!-- Single Client -->
                        <div class="single-client">< <img src="assets/img/client/1.png" alt="client"></div>
                        <div class="single-client">< <img src="assets/img/client/2.png" alt="client"></div>
                        <div class="single-client">< <img src="assets/img/client/3.png" alt="client"></div>
                        <div class="single-client">< <img src="assets/img/client/4.png" alt="client"></div>
                        <div class="single-client">< <img src="assets/img/client/5.png" alt="client"></div>
                        <div class="single-client">< <img src="assets/img/client/6.png" alt="client"></div>
